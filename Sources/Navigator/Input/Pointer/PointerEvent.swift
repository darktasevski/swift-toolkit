...
public enum Pointer: Equatable, Sendable, CustomStringConvertible {
...
/// Type of a pointer.
public enum PointerType: Equatable, Sendable, CaseIterable {
    case touch
    case mouse
}
...
public struct MouseButtons: OptionSet, Equatable, Sendable, CustomStringConvertible {
